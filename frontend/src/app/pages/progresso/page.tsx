              ...
              StepIconProps={{
                sx: {
                  ...
                  '&.Mui-active': {
                    ...
                    fontSize: '2rem', // Tamanho da bolinha ativa
                  },
                  // Estilo para a bolinha (ícone) concluído
                  '&.Mui-completed': {
                    color: 'green', // Cor da bolinha concluída
                    fontSize: '2rem', // Tamanho da bolinha concluída
                  },
                  // Estilo para a bolinha (ícone) inativo
                  '&.Mui-disabled': {
                    color: 'gray', // Cor da bolinha inativa
                    fontSize: '1.5rem', // Tamanho da bolinha inativa
                  },
                },
              }}
            >
